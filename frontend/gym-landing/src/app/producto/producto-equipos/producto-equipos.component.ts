...
@Component({
  ...
  templateUrl: './producto-equipos.component.html',
  styleUrl: './producto-equipos.component.scss'
})
export class ProductoEquiposComponent {
  value = '';
  max = 5000000;
  min = 0;
  step = 50000;
    ...
    this.gService.list('get-imgs-names/')
      ...
      .subscribe((data:any)=>{
        ...
        this.datosComb = this.datos
          .filter(product => product.pcategory === "Equipos Cardiovasculares")
          .map(product => {
